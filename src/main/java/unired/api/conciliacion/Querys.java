...
public class Querys {
    ...
    public static final String CONCILIACION_DIA_ACTUAL = ""
            + "SELECT\n"
            + "	A.IdLogSistema IDLOGSISTEMA,\n"
            + "	A.IdEmpresa IDEMPRESA,\n"
            + "	'GEOCOM' AS CODEMPRESA,\n"
            + "	'GEOCOM' AS NOMBREEPS,\n"
    ...
    public static final String HISTORICO_CONCILIACION = ""
            + "SELECT \n"
            + "	A.FECHAPROCESO,\n"
            ...
            + "			ON A.TipoLog_IdTipo  = C.IdTipo\n"
            + "	) B \n"
            + "	ON A.FECHAPROCESO = B.FECHAPROCESO";
}
